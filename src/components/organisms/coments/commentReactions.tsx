    ...
    return (
        <>
            <div className="comment-footer_menu_reaction_block_button">
                <button data-type="like" onClick={(e) => onClick(e)} className={isLike ? "comment-footer_menu_reaction_button active" : "comment-footer_menu_reaction_button"}>
            ...
            <div className="comment-footer_menu_reaction_block_button">
                <button data-type="dislike" onClick={(e) => onClick(e)} className={isDislike ? "comment-footer_menu_reaction_button active" : "comment-footer_menu_reaction_button"} >
